...
# ABOUTME: Arch comes from env (TARGET/CROSS_TRIPLE/PREFIX/ARCH); run by both
#          deps-arm64 and deps-x64 docker stages. Builds zlib -> openssl ->
#          ncurses -> protobuf into $PREFIX and writes matching .pc files.
set -euo pipefail
